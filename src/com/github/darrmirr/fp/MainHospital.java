...
public interface MainHospital {
    ...
    static void main(String[] args) {
        ...
        var hospital = Chain
                .chain(Hospital.visit(THERAPIST)).responsibility(Hospital.directTo(THERAPIST)::test)
                .chain(Hospital.visit(ANOTHER_DOCTOR)).responsibility(Hospital.directTo(ANOTHER_DOCTOR)::test)
                .chain(Hospital.visit(NURSE)).responsibility(Hospital.directTo(NURSE)::test)
                .chain(Hospital.visit(SURGEON)).responsibility(Hospital.directTo(SURGEON)::test);
